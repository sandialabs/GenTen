...
parser.addParameter('penalty',0,@isscalar);
...
args = { args{:}, 'window-size', parser.Results.window_size, 'window-method', parser.Results.window_method, 'window-weight', parser.Results.window_weight, 'window-penalty', parser.Results.window_penalty, 'factor-penalty', parser.Results.penalty };
